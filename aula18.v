...
(** Estudaremos as árvores binárias de busca em um contexto mais formal. Inicialmente revise o tema fazendo a leitura e os exercícios do capítulo 12 do livro _Introduction to Algorithms, 3rd Edition_, Cormen, Leiserson, and Rivest, MIT Press 2009. *)
...
(** ** Questão 1: *)
(** A primeira questão consiste em provar que uma árvore vazia (de qualquer tipo) é uma árvore binária de busca. *)
...
(** ** Questão 2:  *)
(** A seguir, provaremos que a função [insert] produz uma árvore binária de busca, mas antes prove que a função [insert] preserva qualquer propriedade dos nós: *)
...
Gere um arquivo pdf com a solução desta questão (e com nome questao10-MATRICULA.pdf), onde MATRICULA é o número de sua matrícula (sem barra ou traços, apenas os números). Deixe uma cópia no repositório e coloque outra cópia "impressa" na seção "Exercícios" do seu caderno de atividades.
\end{minipage}}% *)
...
(** ** Questão 13 (3.0 pontos):  *)
(** Qual a complexidade assintótica de [elements_tr]? Esta questão deve ser respondida textualmente em detalhes. 

%\fbox{
\begin{minipage}[h]{15cm}
Gere um arquivo pdf com a solução desta questão (e com nome questao13-MATRICULA.pdf), onde MATRICULA é o número de sua matrícula (sem barra ou traços, apenas os números). Deixe uma cópia no repositório e coloque outra cópia "impressa" na seção "Exercícios" do seu caderno de atividades.\end{minipage}}% *)
